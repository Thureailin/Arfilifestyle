...
//             <Link to={`/shop/men/${id}/${subcategory_id}`}>
//                 <img src={itemImage} className='w-[362.8px] h-[370px] shadow-lg rounded-md '/>
//                 </Link>
//                 <div className='font-bold'>
//                 <p className='mb-5 text-cus-primary mt-2 text-center'>{item_name}</p>
//                 </div>
//                       {sizes?.map((size=>{
//                         return(
//                             <>
