...
const WomenShopdetail = () => {
  ...
  return (
          ...
          {prosize && prosize.length !== 0 ? (
            <div className="" key={prosize[0].item_id}>
              ...
              <div className="text-center ml-[10px] mt-8 lg:ml-[10px] xl:ml-[150px] lg:mt-5 flex overflow-x-auto">
                ...
                <img
                  src={prosize[0].photo_back}
                  onClick={() =>
                    handleChangeImage(prosize[0].photo_back, "chooseColor")
                  }
                  className="w-[80px] h-[80px] lg:mx-0"
                />
                <img
                  src={prosize[0].photo_right}
                  onClick={() =>
                    handleChangeImage(prosize[0].photo_right, "chooseColor")
                  }
                  className="w-[80px] h-[80px] lg:mx-0"
                />
                <img
                  src={prosize[0].photo_left}
                  onClick={() =>
                    handleChangeImage(prosize[0].photo_left, "chooseColor")
                  }
                  className="w-[80px] h-[80px] lg:mx-0"
                />
                <img
                  src={prosize[0].photo_path}
                  onClick={() =>
                    handleChangeImage(prosize[0].photo_path, "chooseColor")
                  }
                  className="w-[80px] h-[80px] lg:mx-0"
                />
                <img
                  src={prosize[0].photo_body}
                  onClick={() =>
                    handleChangeImage(prosize[0].photo_body, "chooseColor")
                  }
                  className="w-[80px] h-[80px] lg:mx-0"
                />
              </div>
            ...
            <div className="" key={product[0].item_id}>
              ...
              <div className="text-center ml-[10px] mt-8 lg:ml-[10px] xl:ml-[150px] lg:mt-5 flex overflow-x-auto">
                ...
                <img
                  src={product[0].photo_back}
                  onClick={() =>
                    handleChangeImage(
                      product[0].photo_back,
                      "",
                      "1",
                      "solid",
                      "black"
                ...
                />
                <img
                  src={product[0].photo_right}
                  onClick={() =>
                    handleChangeImage(
                      product[0].photo_right,
                      "1",
                      "solid",
                      "black"
                    )
                ...
                />
                <img
                  src={product[0].photo_left}
                  onClick={() =>
                    handleChangeImage(
                      product[0].photo_left,
                      "",
                      "1",
                      "solid",
                      "black"
                ...
                />
                <img
                  src={product[0].photo_body}
                  onClick={() =>
                    handleChangeImage(
                      product[0].photo_body,
                      "",
                      "1",
                      "solid",
                      "black"
                ...
                />
                <img
                  src={product[0].photo_path}
                  onClick={() =>
                    handleChangeImage(
                      product[0].photo_path,
                      "",
                      "1",
                      "solid",
                      "black"
    ...
    {product[0].current_quantity == 0 || prosize[0].current_quantity ? <span className='text-red-500'> 0 / Out of Stock</span> : product[0].current_quantity}
  </span>                      {/* } */}
                      {/* {fico[0].current_quantity}
            {(fi.current_quantity === null || fi.selling_price === undefined) ? 0 : fi.current_quantity} */}
                    </span>
                ...
                <>
                  <div className="text-center mb-2 ">
                    <button
                      ...
                      style={{
                        backgroundColor:
                          activeSize === size.id ? "#723e97" : "white",
                    ...
                    <>
                      ...
                      <p
                        ...
                        style={{
                          ...
                          borderRadius: "50%",
                          border: `3px solid ${
                            colorId === co.id ? "black" : "transparent"
                          }`,
                          paddingTop: `${colorId === co.id ? "20px" : "2px"}`, // Change border color based on selection
                          marginLeft: "5px",
                          marginTop: "2px",
                          cursor: "pointer",
                        }}
